  ...
  <div className="flex items-start justify-between gap-4">
    <div className="flex-1">
      ...
      <p className="text-blue-100 text-xs leading-relaxed mb-3">
        Your neighbors have the same builder and the same warranty window. Share Oluso so they can track their claims too{builderName ? ` — link pre-fills ${builderName}` : ''}.{referralCount && referralCount > 0 ? ` ${referralCount} neighbor${referralCount === 1 ? '' : 's'} joined so far!` : ''}
      </p>
      ...
      <div className="flex flex-wrap gap-2">
        <button
          onClick={copyLink}
          className="flex items-center gap-1.5 bg-white text-blue-700 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-colors"
        >

...
import { shouldShowAndroidInstallPrompt, recordAndroidInstallPromptDismissal, getDeferredPrompt, clearDeferredPrompt } from '@/lib/androidInstallPrompt'
...
function LoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.session) {
        ...
        } else if (shouldShowAndroidInstallPrompt(profile?.pwa_installed_at)) {
          setPendingRedirect(target)
  ...
  async function handleAndroidInstall() {
    ...
    if (promptEvent) {
      ...
      if (choice.outcome !== 'accepted') {
        recordAndroidInstallPromptDismissal()
      }
      clearDeferredPrompt()
    }
  ...
  return (
    <>
      ...
      {showAndroidPrompt && <AndroidInstallPrompt onInstall={handleAndroidInstall} onDismiss={handleAndroidDismiss} />}
    </>
  )
}

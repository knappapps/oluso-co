        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center px-4 py-12">
              <div className="w-full max-w-lg">
                      <div className="text-center mb-8">
                                ...
                                <p className="text-gray-500 text-sm mt-1">Let's set up your account</p>p>
                        {referralCode && (
                      ...
                      <div key={s} className="flex-1 flex flex-col items-center gap-1">
                                    ...
                                    <span className={`text-xs ${i === step ? 'text-blue-600 font-semibold' : 'text-gray-400'}`}>{s}</span>span>
                      </div>div>
                    ))}
                      </div>div>
                      ...
                      <div>
                                    <div className="flex items-center gap-3 mb-6">
                                                    ...
                                                    <div>
                                                                      <h2 className="font-bold text-gray-900">Your home address</h2>h2>
                                                                      <p className="text-xs text-gray-500">We use this to match your community and builder</p>p>
                                                    </div>div>
                                    </div>div>
                      ...
                      <div>
                                    <div className="flex items-center gap-3 mb-6">
                                                    ...
                                                    <div>
                                                                      <h2 className="font-bold text-gray-900">Your homebuilder</h2>h2>
                                                                      <p className="text-xs text-gray-500">Who built your home?</p>p>
                                                    </div>div>
                                    </div>div>
                                    <div className="space-y-3">
                                                    <div>
                                                                      ...
                                                                      <select
                                                                                            ...
                                                                                            className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                                                          >
                                                                                          <option value="">Select your builder...</option>option>
                                                                        {BUILDERS.map(b => <option key={b} value={b}>{b}</option>option>)}
                                                                      </select>select>
                                                    </div>div>
                                      {form.builder_name === 'Other' && (
                                          <div>
                                                              <label className="block text-xs font-medium text-gray-700 mb-1">Builder name</label>label>
                                            {input('builder_name', 'Enter builder name')}
                                          </div>div>
                                                    )}
                                                    <div>
                                                                      <label className="block text-xs font-medium text-gray-700 mb-1">Community / subdivision name</label>label>
                                                      {input('community_name', 'e.g. Sage Creek Estates')}
                                                    </div>div>
                                                    <div>
                                                                      <label className="block text-xs font-medium text-gray-700 mb-1">Builder warranty email (optional)</label>label>
                                                      {input('builder_email', 'warranty@yourbuilder.com', 'email')}
                                                                      <p className="text-xs text-gray-400 mt-1">Used to pre-fill when you send claims</p>p>
                                                    </div>div>
                                    </div>div>
                      </div>div>
                                )}
                      ...
                      <div>
                                    <div className="flex items-center gap-3 mb-6">
                                                    ...
                                                    <div>
                                                                      <h2 className="font-bold text-gray-900">Warranty period</h2>h2>
                                                                      <p className="text-xs text-gray-500">When does your builder warranty run?</p>p>
                                                    </div>div>
                                    </div>div>
                                    <div className="space-y-4">
                                                    <div>
                                                                      <label className="block text-xs font-medium text-gray-700 mb-1">Warranty start date</label>label>
                                                                      <input
                                                                                            type="date"
                                                                                            ...
                                                                                            className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                                                          />
                                                                      <p className="text-xs text-gray-400 mt-1">Usually your closing date or move-in date</p>p>
                                                    </div>div>
                                                    <div>
                                                                      <label className="block text-xs font-medium text-gray-700 mb-1">Warranty end date</label>label>
                                                      {input('warranty_end', '', 'date')}
                                                                      <p className="text-xs text-gray-400 mt-1">Most builders offer 1-year structural warranty</p>p>
                                                    </div>div>
                                      {form.warranty_year && (
                                          <div className="bg-blue-50 rounded-lg p-3 text-xs text-blue-700">
                                                              <strong>Warranty year detected:</strong>strong> {form.warranty_year}
                                          </div>div>
                                                    )}
                                                    <div className="bg-gray-50 rounded-lg p-3 text-xs text-gray-500">
                                                                      <strong>Tip:</strong>strong> Check your closing documents or builder warranty booklet for exact dates.
                                                    </div>div>
                                    </div>div>
                      </div>div>
                                )}
                      ...
                      <div className="text-center py-4">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900 mb-2">You're all set!</h2>h2>
                                    <p className="text-gray-500 text-sm mb-2">Your account is ready. You can now file claims, track builder responses, and build your documentation trail.</p>p>
                                    <div className="bg-gray-50 rounded-xl p-4 mt-4 text-left text-sm space-y-2">
                                                    <div className="flex justify-between"><span className="text-gray-500">Home</span>span><span className="font-medium text-gray-800">{form.address}, {form.city}</span>span></div>div>
                                                    <div className="flex justify-between"><span className="text-gray-500">Builder</span>span><span className="font-medium text-gray-800">{form.builder_name || 'Not set'}</span>span></div>div>
                                                    <div className="flex justify-between"><span className="text-gray-500">Community</span>span><span className="font-medium text-gray-800">{form.community_name || 'Not set'}</span>span></div>div>
                                                    <div className="flex justify-between"><span className="text-gray-500">Warranty</span>span><span className="font-medium text-gray-800">{form.warranty_start ? form.warranty_start + ' \u2192 ' + (form.warranty_end || 'TBD') : 'Not set'}</span>span></div>div>
                                      {form.warranty_year && (
                                          <div className="flex justify-between"><span className="text-gray-500">Warranty year</span>span><span className="font-medium text-gray-800">{form.warranty_year}</span>span></div>div>
                                                    )}
                                    </div>div>
                      </div>div>
                                )}

...
exports.handler = async function(event) {
  ...
  try {
    ...
    await supabase.from('messages').insert({
      ...
      subject: emailSubject,
      body: emailBody,
      message_id: emailData && emailData.id
    })
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ success: true, email_id: emailData && emailData.id, from: fromAddress })
    }
  } catch (err) {

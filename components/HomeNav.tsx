          ...
          <nav className="relative border-b border-gray-100 px-4 sm:px-6 py-4 flex items-center justify-between">
                ...
                {open && (
                      <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg px-4 py-4 space-y-1 z-50">
                            <Link href="/builders" onClick={() => setOpen(false)} className="block px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-100">Builders</Link>
                            <Link href="/community" onClick={() => setOpen(false)} className="block px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-gray-100">Community</Link>
